...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    image, label = image_preprocessing_fn(image, eval_image_size, eval_image_size, bbox=bbox, landmarks=landmark_2d)
    ...
    names_to_values, names_to_updates = slim.metrics.aggregate_metric_map({
        'Mean Absolute Error': tf.metrics.mean_absolute_error(predictions, labels),
    })
