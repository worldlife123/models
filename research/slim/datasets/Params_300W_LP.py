...
_ITEMS_TO_DESCRIPTIONS = {
    ...
    'landmark_3d': 'A flat 68 landmark label(136 numbers)',
    'pose': '[pitch, yaw, roll, tdx, tdy, tdz, scale](7 numbers)'
}
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  keys_to_features = {
      ...
      'image/face/landmark_2d': tf.VarLenFeature(dtype=tf.float32),
