...
# ==============================================================================
"""Provides data for the 300W_LP dataset.
...
_FILE_PATTERN = 'landmark_300VW_custom_fd_%s_*.tfrecord'

SPLITS_TO_SIZES = {'train': 29206}

_NUM_CLASSES = 136

_ITEMS_TO_DESCRIPTIONS = {
    'image': 'A color image of varying size.',
    'landmark_2d': 'A flat 68 landmark label(136 numbers)',
}
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  items_to_handlers = {
      ...
      'landmarks': slim.tfexample_decoder.Tensor('image/face/landmark_2d', shape=[136]),
      'label': slim.tfexample_decoder.Tensor('image/face/landmark_2d', shape=[136]),
  }
